...
import static utilities.DBConnection.checkPay;
...
public class SandSheetController implements Initializable {
    ...
    void submit(ActionEvent event) {
        ...
        if (alertResult.get() == ButtonType.YES) {
            ...
            String sqlStatement = "UPDATE timesheet SET hours = "+ hours + ", date_submitted = curdate(), gross_pay = "+ grossPay+" WHERE timesheetID = "+timesheetID +" ;";
